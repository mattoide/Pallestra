...
<head>
  ...
  <!-- Custom css -->
  <link rel="stylesheet" href="../css/dashboardMobileStyle.css">
...
<script>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark" style="margin: 5px;">
    ...
    <div class="collapse navbar-collapse ml-auto" id="navbarSupportedContent">
      <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="nickname" role="button" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">
